...
public class Reading {
    ...
    public static String test = "create table reading (code text not null, aDate text not null, value Integer)";
    ...
    public Reading(int _id, String code, String date, String reading){
        this.code = code;
        this.date = date;
